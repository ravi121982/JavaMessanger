...
import org.wube.aps.messanger.resources.beans.MessageFilterBean;
import org.wube.aps.messanger.service.MessageService;
...
public class MessageResource {
	...
	private String getUriForComments(UriInfo uriInfo, Message message) {
		String uri = uriInfo.getBaseUriBuilder()
				...
				.path(CommentResource.class, "getCommentResource")
	...
	public CommentResource getCommneetResource(){
